...
Client-side Fabric mod for Hypixel SkyBlock (Minecraft 1.21.10, SkyBlock protocol 26.1.2, Java 25). Three modules today: **i4 Helper** (Catacombs F7/M7 4th-device puzzle), **Tiki Helper** (Sneaky Tiki hunting) and **Tree Tracker** (Helix/Fig/Mangrove gift rates).
