...
Client-side Fabric mod for Hypixel SkyBlock (Minecraft 1.21.10, SkyBlock protocol 26.1.2, Java 25). Modules today: **i4 Helper** (Catacombs F7/M7 4th-device puzzle), **Tiki Helper** (Sneaky Tiki hunting), **Tree Tracker** (Helix/Fig/Mangrove gift rates), **Tree Broken Notifier** (felled/gift title) and **Theme** (the shared look).
